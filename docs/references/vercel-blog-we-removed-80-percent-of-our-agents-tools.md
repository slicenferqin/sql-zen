...
> 原文链接: https://vercel.com/blog/we-removed-80-percent-of-our-agents-tools
> 作者: Andrew Qu
...
**旧架构示例 (ai-sdk@6.0.0-beta.160 ToolLoopAgent):**
...
**新架构示例 (ai-sdk@6.0.0 ToolLoopAgent):**
...
1. **极简架构**: 从 15+ 工具减少到 2 个（bash + SQL）
2. **信任模型**: 不要过度约束，让模型自己探索和推理
3. **文档为王**: 高质量的 Schema 文档是成功的前提
4. **做减法**: 最好的 Agent 可能是工具最少的 Agent
